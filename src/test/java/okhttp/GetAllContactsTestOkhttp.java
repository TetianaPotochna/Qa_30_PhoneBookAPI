...
public class GetAllContactsTestOkhttp {
    String token = "eyJhbGciOiJIUzI1NiJ9.eyJyb2xlcyI6WyJST0xFX1VTRVIiXSwic3ViIjoiZHVzbTVAZ21haWwuY29tIiwiaXNzIjoiUmVndWxhaXQiLCJleHAiOjE3NTkwNzE3MDIsImlhdCI6MTc1ODQ3MTcwMn0.nJPBfDVQqa--Z2FwnMTJ3p9fzDgxo5Wp3MWE89xpCyg";
    Gson gson = new Gson();
    ...
    public void getAllContactsWrongToken() throws IOException {
        Request request = new Request.Builder()
                .url("https://contactapp-telran-backend.herokuapp.com/v1/contacts")
                .get()
                .addHeader("Authorization", "jbjbhjvhgfgcfgdxfdx")
                .build();
